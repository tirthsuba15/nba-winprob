...
| xgboost (mean + 80% interval) | 4.55 | 77.7% | 13.6 pts |
...
pregame blowout proxy each contribute ~0.004 — small, but included and reported
honestly. Interval coverage is spot-on (79.5% vs the 80% target).
