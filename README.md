...
| xgboost (mean + 80% interval) | 4.56 | 79.5% | 14.4 pts |
...
also applies **recency weighting** — each player's last 7 games count 3× the
earlier ones. Opponent pace / defensive rating / defense-vs-position and the
